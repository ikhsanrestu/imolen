...
<head>
    ...
    <title>Form Absen Safety Induction</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header text-center">
                        <h4>Form Absen Safety Inductiont</h4>
                    </div>
                    <div class="card-body">
                        <form action="/saction/simpan" method="POST">
                            <!-- CSRF Token (Laravel specific) -->
                            @csrf
                            <!-- ID Presensi -->
                            <div class="mb-3">
                                <label for="id_presensi" class="form-label">ID Presensi</label>
                                <input type="text" class="form-control" id="id_presensi" name="id_presensi" placeholder="Masukkan ID Presensi, - jika belum ada" required>
                            </div>
